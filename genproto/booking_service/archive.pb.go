...
// source: models_booking_service/archive.proto
...
func init() {
	proto.RegisterType((*Archive)(nil), "models_booking_service.Archive")
	proto.RegisterType((*Archives)(nil), "models_booking_service.Archives")
	proto.RegisterType((*CreateArchiveReq)(nil), "models_booking_service.CreateArchiveReq")
	proto.RegisterType((*UpdateArchiveReq)(nil), "models_booking_service.UpdateArchiveReq")
	proto.RegisterType((*ArchiveFieldValueReq)(nil), "models_booking_service.ArchiveFieldValueReq")
	proto.RegisterType((*DeleteArchiveStatus)(nil), "models_booking_service.DeleteArchiveStatus")
	proto.RegisterType((*GetAllArchivesReq)(nil), "models_booking_service.GetAllArchivesReq")
}

func init() { proto.RegisterFile("models_booking_service/archive.proto", fileDescriptor_9b57b3fb89da7a89) }
...
func (c *archiveServiceClient) CreateArchive(ctx context.Context, in *CreateArchiveReq, opts ...grpc.CallOption) (*Archive, error) {
	out := new(Archive)
	err := c.cc.Invoke(ctx, "/models_booking_service.ArchiveService/CreateArchive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *archiveServiceClient) GetArchive(ctx context.Context, in *ArchiveFieldValueReq, opts ...grpc.CallOption) (*Archive, error) {
	out := new(Archive)
	err := c.cc.Invoke(ctx, "/models_booking_service.ArchiveService/GetArchive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *archiveServiceClient) GetAllArchives(ctx context.Context, in *GetAllArchivesReq, opts ...grpc.CallOption) (*Archives, error) {
	out := new(Archives)
	err := c.cc.Invoke(ctx, "/models_booking_service.ArchiveService/GetAllArchives", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *archiveServiceClient) UpdateArchive(ctx context.Context, in *UpdateArchiveReq, opts ...grpc.CallOption) (*Archive, error) {
	out := new(Archive)
	err := c.cc.Invoke(ctx, "/models_booking_service.ArchiveService/UpdateArchive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *archiveServiceClient) DeleteArchive(ctx context.Context, in *ArchiveFieldValueReq, opts ...grpc.CallOption) (*DeleteArchiveStatus, error) {
	...
	err := c.cc.Invoke(ctx, "/models_booking_service.ArchiveService/DeleteArchive", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ArchiveService_CreateArchive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.ArchiveService/CreateArchive",
	}
...
func _ArchiveService_GetArchive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.ArchiveService/GetArchive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ArchiveService_GetAllArchives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.ArchiveService/GetAllArchives",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ArchiveService_UpdateArchive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.ArchiveService/UpdateArchive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ArchiveService_DeleteArchive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.ArchiveService/DeleteArchive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ArchiveService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "models_booking_service.ArchiveService",
	...
	Metadata: "models_booking_service/archive.proto",
}
