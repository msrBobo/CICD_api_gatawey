...
// source: models_booking_service/patient.proto
...
func init() {
	proto.RegisterType((*Patient)(nil), "models_booking_service.Patient")
	proto.RegisterType((*Patients)(nil), "models_booking_service.Patients")
	proto.RegisterType((*CreatePatientReq)(nil), "models_booking_service.CreatePatientReq")
	proto.RegisterType((*UpdatePatientReq)(nil), "models_booking_service.UpdatePatientReq")
	proto.RegisterType((*UpdatePhoneNumber)(nil), "models_booking_service.UpdatePhoneNumber")
	proto.RegisterType((*PatientFieldValueReq)(nil), "models_booking_service.PatientFieldValueReq")
	proto.RegisterType((*PatientStatus)(nil), "models_booking_service.PatientStatus")
	proto.RegisterType((*GetAllPatientsReq)(nil), "models_booking_service.GetAllPatientsReq")
}

func init() { proto.RegisterFile("models_booking_service/patient.proto", fileDescriptor_e8c5f44427ac9dcc) }
...
func (c *patientsServiceClient) CreatePatient(ctx context.Context, in *CreatePatientReq, opts ...grpc.CallOption) (*Patient, error) {
	out := new(Patient)
	err := c.cc.Invoke(ctx, "/models_booking_service.PatientsService/CreatePatient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *patientsServiceClient) GetPatient(ctx context.Context, in *PatientFieldValueReq, opts ...grpc.CallOption) (*Patient, error) {
	out := new(Patient)
	err := c.cc.Invoke(ctx, "/models_booking_service.PatientsService/GetPatient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *patientsServiceClient) GetAllPatients(ctx context.Context, in *GetAllPatientsReq, opts ...grpc.CallOption) (*Patients, error) {
	out := new(Patients)
	err := c.cc.Invoke(ctx, "/models_booking_service.PatientsService/GetAllPatients", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *patientsServiceClient) UpdatePatient(ctx context.Context, in *UpdatePatientReq, opts ...grpc.CallOption) (*Patient, error) {
	out := new(Patient)
	err := c.cc.Invoke(ctx, "/models_booking_service.PatientsService/UpdatePatient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *patientsServiceClient) UpdatePhonePatient(ctx context.Context, in *UpdatePhoneNumber, opts ...grpc.CallOption) (*PatientStatus, error) {
	...
	err := c.cc.Invoke(ctx, "/models_booking_service.PatientsService/UpdatePhonePatient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *patientsServiceClient) DeletePatient(ctx context.Context, in *PatientFieldValueReq, opts ...grpc.CallOption) (*PatientStatus, error) {
	out := new(PatientStatus)
	err := c.cc.Invoke(ctx, "/models_booking_service.PatientsService/DeletePatient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PatientsService_CreatePatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.PatientsService/CreatePatient",
	}
...
func _PatientsService_GetPatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.PatientsService/GetPatient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PatientsService_GetAllPatients_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.PatientsService/GetAllPatients",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PatientsService_UpdatePatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.PatientsService/UpdatePatient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PatientsService_UpdatePhonePatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.PatientsService/UpdatePhonePatient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PatientsService_DeletePatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.PatientsService/DeletePatient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _PatientsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "models_booking_service.PatientsService",
	...
	Metadata: "models_booking_service/patient.proto",
}
