...
// source: models_booking_service/doctor_times.proto
...
func init() {
	proto.RegisterType((*DoctorTime)(nil), "models_booking_service.DoctorTime")
	proto.RegisterType((*DoctorTimes)(nil), "models_booking_service.DoctorTimes")
	proto.RegisterType((*CreateDoctorTimeReq)(nil), "models_booking_service.CreateDoctorTimeReq")
	proto.RegisterType((*UpdateDoctorTimeReq)(nil), "models_booking_service.UpdateDoctorTimeReq")
	proto.RegisterType((*DoctorTimeFieldValueReq)(nil), "models_booking_service.DoctorTimeFieldValueReq")
	proto.RegisterType((*DoctorTimeDeleteStatus)(nil), "models_booking_service.DoctorTimeDeleteStatus")
	proto.RegisterType((*GetAllDoctorTimesReq)(nil), "models_booking_service.GetAllDoctorTimesReq")
}

func init() {
	proto.RegisterFile("models_booking_service/doctor_times.proto", fileDescriptor_a87a3b7fa39be7cd)
}
...
func (c *doctorTimeServiceClient) CreateDoctorTime(ctx context.Context, in *CreateDoctorTimeReq, opts ...grpc.CallOption) (*DoctorTime, error) {
	out := new(DoctorTime)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorTimeService/CreateDoctorTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorTimeServiceClient) GetDoctorTime(ctx context.Context, in *DoctorTimeFieldValueReq, opts ...grpc.CallOption) (*DoctorTime, error) {
	out := new(DoctorTime)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorTimeService/GetDoctorTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorTimeServiceClient) GetAllDoctorTimes(ctx context.Context, in *GetAllDoctorTimesReq, opts ...grpc.CallOption) (*DoctorTimes, error) {
	out := new(DoctorTimes)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorTimeService/GetAllDoctorTimes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorTimeServiceClient) UpdateDoctorTime(ctx context.Context, in *UpdateDoctorTimeReq, opts ...grpc.CallOption) (*DoctorTime, error) {
	out := new(DoctorTime)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorTimeService/UpdateDoctorTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorTimeServiceClient) DeleteDoctorTime(ctx context.Context, in *DoctorTimeFieldValueReq, opts ...grpc.CallOption) (*DoctorTimeDeleteStatus, error) {
	...
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorTimeService/DeleteDoctorTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DoctorTimeService_CreateDoctorTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorTimeService/CreateDoctorTime",
	}
...
func _DoctorTimeService_GetDoctorTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorTimeService/GetDoctorTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoctorTimeService_GetAllDoctorTimes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorTimeService/GetAllDoctorTimes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoctorTimeService_UpdateDoctorTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorTimeService/UpdateDoctorTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoctorTimeService_DeleteDoctorTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorTimeService/DeleteDoctorTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _DoctorTimeService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "models_booking_service.DoctorTimeService",
	...
	Metadata: "models_booking_service/doctor_times.proto",
}
