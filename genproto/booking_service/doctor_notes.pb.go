...
// source: models_booking_service/doctor_notes.proto
...
func init() {
	proto.RegisterType((*DoctorNote)(nil), "models_booking_service.DoctorNote")
	proto.RegisterType((*DoctorNotes)(nil), "models_booking_service.DoctorNotes")
	proto.RegisterType((*CreateDoctorNoteReq)(nil), "models_booking_service.CreateDoctorNoteReq")
	proto.RegisterType((*UpdateDoctorNoteReq)(nil), "models_booking_service.UpdateDoctorNoteReq")
	proto.RegisterType((*FieldValueReq)(nil), "models_booking_service.FieldValueReq")
	proto.RegisterType((*StatusRes)(nil), "models_booking_service.StatusRes")
	proto.RegisterType((*GetAllReq)(nil), "models_booking_service.GetAllReq")
}

func init() {
	proto.RegisterFile("models_booking_service/doctor_notes.proto", fileDescriptor_1b7cb9d02c1f873f)
}
...
func (c *doctorNotesServiceClient) CreateDoctorNote(ctx context.Context, in *CreateDoctorNoteReq, opts ...grpc.CallOption) (*DoctorNote, error) {
	out := new(DoctorNote)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorNotesService/CreateDoctorNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorNotesServiceClient) GetDoctorNote(ctx context.Context, in *FieldValueReq, opts ...grpc.CallOption) (*DoctorNote, error) {
	out := new(DoctorNote)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorNotesService/GetDoctorNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorNotesServiceClient) GetAllNotes(ctx context.Context, in *GetAllReq, opts ...grpc.CallOption) (*DoctorNotes, error) {
	out := new(DoctorNotes)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorNotesService/GetAllNotes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorNotesServiceClient) UpdateDoctorNote(ctx context.Context, in *UpdateDoctorNoteReq, opts ...grpc.CallOption) (*DoctorNote, error) {
	out := new(DoctorNote)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorNotesService/UpdateDoctorNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doctorNotesServiceClient) DeleteDoctorNote(ctx context.Context, in *FieldValueReq, opts ...grpc.CallOption) (*StatusRes, error) {
	out := new(StatusRes)
	err := c.cc.Invoke(ctx, "/models_booking_service.DoctorNotesService/DeleteDoctorNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DoctorNotesService_CreateDoctorNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorNotesService/CreateDoctorNote",
	}
...
func _DoctorNotesService_GetDoctorNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorNotesService/GetDoctorNote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoctorNotesService_GetAllNotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorNotesService/GetAllNotes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoctorNotesService_UpdateDoctorNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorNotesService/UpdateDoctorNote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoctorNotesService_DeleteDoctorNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models_booking_service.DoctorNotesService/DeleteDoctorNote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _DoctorNotesService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "models_booking_service.DoctorNotesService",
	...
	Metadata: "models_booking_service/doctor_notes.proto",
}
