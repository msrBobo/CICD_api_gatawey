...
import (
	...
	"CICD_api_gatawey/api/models/model_healthcare_service"
	pb "CICD_api_gatawey/genproto/healthcare-service"
	"context"
	"net/http"
	"time"
...
// @Accept json
// @Produce json
// @Param DeleteDoctorWorkingHoursReq query models.FieldValueReq true "FieldValueReq"
